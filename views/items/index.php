...
<div class="widget-banner-items-index">
    ...
    <div class="item-container margin-top-30 margin-bottom-20">
        <?= Html::a(Yii::t('app', 'Create Banner Item'), ['create'], ['class' => 'btn btn-secondary']) ?>
            ...
            'columns'      => [
                ...
                [
                    ...
                    'value'     => function ($model) {
                        ...
                        if (is_object($m)) {
                            return '<div><img src="'. Yii::$app->params['frontend'] . '/images/widget/banner/' . $m->file . '" height="100" /></div>';
                        }
