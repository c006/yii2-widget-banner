...
class Module extends \yii\base\Module
{
     ...
     * @var string
     */
    public $controllerNamespace = 'c006\widget\banner\controllers';
    ...
    public function createController($route)
    {
        ...
        $this->defaultRoute = (!$this->defaultRoute || $this->defaultRoute == 'default') ? 'banner' : $this->defaultRoute;
